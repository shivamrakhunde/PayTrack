...
public class billing extends javax.swing.JFrame {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (stockquantity >= quantity) {
                    ...
                    model.addRow(
                            new Object[] { jTextField10.getText(), price, jTextField12.getText(), quantity, total });
                    finaltotal += total;
                    jTextField5.setText(String.valueOf(finaltotal));
                } else {
                    JOptionPane.showMessageDialog(null, "Quantity Entered exceeds the InStock Quantity that is  : "
                            + rs.getString(1) + " ! Please Reenter the Quantity");
                }
            }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null,
                        "There is no entry which is matching the keyword,Please Try Again !");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to save the bill ?", "Bill Confirmation",
        ...
        if (a == 0) {
            ...
            String path = "C:\\Users\\shiva\\OneDrive\\Desktop\\Bills\\" + Name + "_" + Date + ".pdf";
            com.itextpdf.text.Document doc = new com.itextpdf.text.Document();
            try {
                PdfWriter.getInstance(doc, new FileOutputStream(path));
                doc.open();
                Paragraph p1 = new Paragraph(
                        "--------------------------------------WELCOME TO MINESH PRODUCTS---------------------------------------\n");
                Paragraph p2 = new Paragraph(
                        "-------------------------------Please Contact For Further Enquiry :(+91)91235789845 --------------------\n\n");
                doc.add(p1);
                doc.add(p2);
